...
<div class="row g-3 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="card card-stat p-4" style="--stat-color:#dbeafe;--stat-text:#1d4ed8;">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Customer</div><div class="stat-value">{{ $totalUsers }}</div></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card card-stat p-4" style="--stat-color:#fef3c7;--stat-text:#92400e;">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Total Booking</div><div class="stat-value">{{ $totalReservations }}</div></div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card card-stat p-4" style="--stat-color:#fee2e2;--stat-text:#991b1b;">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Revenue Paid</div><div class="stat-value fs-4">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</div></div>
            ...
            <div class="card-body p-4">
                <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <div class="section-subtitle">Status booking dan pembayaran saat ini.</div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="p-3 rounded-4 bg-light border">
                            <small class="text-muted fw-bold">Booking Hari Ini</small>
                            <h4 class="fw-bold mt-2 mb-0">{{ $todayReservations }}</h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 rounded-4 bg-light border">
                            <small class="text-muted fw-bold">Revenue Bulan Ini</small>
                            <h4 class="fw-bold mt-2 mb-0">Rp {{ number_format($monthlyRevenue, 0, ',', '.') }}</h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="p-3 rounded-4 bg-light border">
                            <small class="text-muted fw-bold">Tagihan Pending</small>
                    ...
                    <div class="col-md-6">
                        <div class="p-3 rounded-4 border h-100">
                            ...
                            @foreach(['Paid','Pending','Cancelled'] as $status)
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="badge-soft {{ $status === 'Paid' ? 'badge-completed' : ($status === 'Pending' ? 'badge-booking' : 'badge-cancelled') }}">{{ $status }}</span>
                                    <strong>{{ $total }}</strong>
                                </div>
                            @endforeach
                        </div>
        ...
        <div class="card content-card h-100">
            <div class="card-body p-4">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.reservations.index') }}" class="btn btn-soft rounded-4 text-start py-3"><i class="fa-solid fa-calendar-check me-2 text-warning"></i> Kelola Booking</a>
...
<div class="card content-card">
    <div class="card-body p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h5 class="section-title">Booking Terbaru</h5>
                <div class="section-subtitle">Data booking terakhir yang masuk ke sistem.</div>
            </div>
            <a href="{{ route('admin.reservations.index') }}" class="btn btn-soft rounded-4">Lihat Semua</a>
        </div>
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                <thead><tr><th>Customer</th><th>Fasilitas</th><th>Waktu</th><th>Status</th><th>Pembayaran</th><th>Total</th></tr></thead>
                <tbody>
                ...
                @empty
                    <tr><td colspan="6"><div class="empty-state"><i class="fa-regular fa-calendar-xmark"></i><div>Belum ada booking.</div></div></td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
