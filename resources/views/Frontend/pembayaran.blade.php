        ...
        <div class="container" style="max-width: 980px;">
            <div class="payment-panel polished-payment-panel">
                <div class="text-center payment-page-heading">
                    ...
                    <span class="section-eyebrow mt-3">Pembayaran Booking</span>
                    <h1>Halaman Pembayaran</h1>
                    <p>Selesaikan pembayaran sesuai metode yang dipilih untuk proses konfirmasi booking.</p>
                </div>
                ...
                <div class="payment-summary-card polished-summary-card mb-4">
                    <div class="payment-summary-grid">
                        ...
                        <div>
                            <p class="payment-label">Customer</p>
                    ...
                    <div class="payment-booking-detail mt-4">
                        <h5><i class="fa-solid fa-calendar-check me-2"></i>Detail Booking</h5>
